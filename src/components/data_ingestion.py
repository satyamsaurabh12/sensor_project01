...
from zipfile import Path  # this is deal with path 
...
class DataIngestion:
    ...
    def export_collection_as_dataframe(self,collection_name,db_name):
        ...
        try:
            ...
            # Fetch data from the collection and convert it to a DataFrame
    ...
    def export_data_into_feature_store_file_path(self)->pd.DataFrame:
        try:
            ...
            looging.info(f"Exporting data from mogodb")
    ...
    def initiate_data_ingestion(self) -> Path:
        ...
        try:
            ...
            logging.info("existed initiate_data_ingestion methods of data ingestion class")
