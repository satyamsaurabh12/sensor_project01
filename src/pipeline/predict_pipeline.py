...
class PredictionPipelineConfig:
    ...
    preprocessor_file_path:str = os.path.join(artifact_folder,'preprocessor.csv')
...
class PredictionPipeline:
    ...
    def predict(self,feature):
        ...
        try:
            ...
            preprocessor = self.utils.load_object(file_path=self.prediction_pipeline_config.preprocessor.path)

            transformend_x = preprocessor.transform(feature)
            preds= model.predict(transformend_x)
    ...
    def get_predicted_dataframe(self,input_dataframe_path : pd.DataFrame):
        ...
        try:
            ...
            logging.info("prediction complited")
        except Exception as e:
